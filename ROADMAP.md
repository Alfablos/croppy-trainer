...
2. Add to transforms: RandomPerspective, ScaleJitter, RandomRotation, ElasticTransform, RandomChannelPermutation, RandomResize,  GaussianBlur, GaussianNoise, RandomAffine
